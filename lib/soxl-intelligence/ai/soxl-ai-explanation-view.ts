...
const issueMessages: Record<SoxlAiCurrentExplanationIssue, string> = {
    ...
    unexpected_server_metadata_field: 'The AI response did not pass the grounding and safety checks.',
    ...
    section_missing: 'The AI response did not pass the grounding and safety checks.',
    section_not_array: 'The AI response did not pass the grounding and safety checks.',
    section_too_many: 'The AI response did not pass the grounding and safety checks.',
    section_item_not_object: 'The AI response did not pass the grounding and safety checks.',
    section_item_missing_required_field: 'The AI response did not pass the grounding and safety checks.',
    section_item_field_wrong_type: 'The AI response did not pass the grounding and safety checks.',
    section_item_unexpected_field: 'The AI response did not pass the grounding and safety checks.',
    other_section_shape_mismatch: 'The AI response did not pass the grounding and safety checks.',
    evidence_refs_missing: 'The AI response did not pass the grounding and safety checks.',
    evidence_refs_not_array: 'The AI response did not pass the grounding and safety checks.',
    evidence_refs_empty: 'The AI response did not pass the grounding and safety checks.',
    evidence_refs_too_many: 'The AI response did not pass the grounding and safety checks.',
    evidence_ref_not_string: 'The AI response did not pass the grounding and safety checks.',
    evidence_ref_blank: 'The AI response did not pass the grounding and safety checks.',
