...
const issueMessages: Record<SoxlAiCurrentExplanationIssue, string> = {
    ...
    evidence_ids_missing: 'The AI response did not pass the grounding and safety checks.',
    evidence_ids_not_array: 'The AI response did not pass the grounding and safety checks.',
    evidence_ids_empty: 'The AI response did not pass the grounding and safety checks.',
    evidence_ids_too_many: 'The AI response did not pass the grounding and safety checks.',
    evidence_id_not_string: 'The AI response did not pass the grounding and safety checks.',
    evidence_id_blank: 'The AI response did not pass the grounding and safety checks.',
    evidence_id_duplicate: 'The AI response did not pass the grounding and safety checks.',
